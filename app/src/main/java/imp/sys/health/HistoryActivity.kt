...
class HistoryActivity : AppCompatActivity() {
    ...
    private lateinit var btnDeleteHistory: Button
        ...
        GlobalScope.launch(Dispatchers.IO) {
            ...
            withContext(Dispatchers.Main) {
                if (healthReport != null) {
                    ...
                    clearHistoryTextViews()
                    Toast.makeText(this@HistoryActivity, "No history to display", Toast.LENGTH_SHORT).show()
                }
            }
        }
    }
    ...
    private fun deleteHistory() {
        GlobalScope.launch(Dispatchers.IO) {
            healthReportDatabase.healthReportDao().deleteAllReports()
            withContext(Dispatchers.Main) {
                clearHistoryTextViews()
    ...
    private fun clearHistoryTextViews() {
        tvHistoryTimestamp.text = "Timestamp: "
        tvHistoryHeartRate.text = "Heart Rate: "
        tvHistoryRespiratoryRate.text = "Respiratory Rate: "
        tvHistoryNausea.text = "Nausea: "
        tvHistoryHeadache.text = "Headache: "
        tvHistoryDiarrhoea.text = "Diarrhoea: "
        tvHistorySoarThroat.text = "Soar Throat: "
        tvHistoryFever.text = "Fever: "
        tvHistoryMuscleAche.text = "Muscle Ache: "
        tvHistoryLossOfSmellOrTaste.text = "Loss of Smell or Taste: "
        tvHistoryCough.text = "Cough: "
        tvHistoryShortnessOfBreath.text = "Shortness of Breath: "
        tvHistoryFeelingTired.text = "Feeling Tired: "
    }
